...
export default [
    new ProjectData("project-1", "Simple Crypto WebGL Templates", "img/projects/project-2.png", `
    <div class="paragraph">
        <strong>Simple Crypto WebGL Templates</strong> enabled anybody to get NFT data into their game by simply selecting a WebGL template in Player Settings for their preffered blockchain then simply Build! It comes with a demo which give you all the necessary code to get the data you want to reference for each of a users NFTs.
    </div>
    ...
    `, "#5a78af"),
    new ProjectData("project-2", "Mini Battles", "img/projects/project-1.png", 
    `
    <div class="paragraph">
    ...
    `, "#23bd69", true),
    new ProjectData("project-3", "YouTube Channel", "img/projects/project-2.png", `
    <div class="paragraph">
